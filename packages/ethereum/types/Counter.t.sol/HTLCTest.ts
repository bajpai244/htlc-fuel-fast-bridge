...
export interface HTLCTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      ...
      | "testTimelockWithERC20InsufficientBalance"
  ...
  encodeFunctionData(
    functionFragment: "testTimelockWithERC20InsufficientBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface HTLCTest extends BaseContract {
  ...
  testTimelockWithERC20InsufficientBalance: TypedContractMethod<
    [],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "testTimelockWithERC20InsufficientBalance"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
